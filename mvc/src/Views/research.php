        ...
        <main class="lg:pl-56 pt-[70px] h-full">
                <div class="flex flex-col relative h-full">
                    <div class="flex items-center py-2 px-4 ">
                        ...
                        echo('<a href="/dashboard/research/create" class="ml-auto text-sm bg-slate-950 rounded px-6 py-3 text-white font-[500]">New Researcher</a>');
                        }
                        ?>
                    </div>
                    <div class="p-6 h-full">
                        <table class="w-full">
                            ...
                            <?php foreach ($researchers as $researcher) : echo("
                            <tr>
                                <td class='py-3'>".$researcher["username"]."</td>
